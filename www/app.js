(function () {
  ...
  var traducciones = {
    es: {
      ...
      modoContrarrelojSub: "Resuelve la mayor cantidad de tableros",
    ...
    en: {
      ...
      modoContrarrelojSub: "Solve as many boards as you can",
    ...
    fr: {
      ...
      modoContrarrelojSub: "Résous le plus de plateaux possible",
    ...
    de: {
      ...
      modoContrarrelojSub: "Löse so viele Bretter wie möglich",
    ...
    ru: {
      ...
      modoContrarrelojSub: "Реши как можно больше досок",
  ...
  function playSound() {
    ...
    try {
      if (window.OchoDamasAudio && window.OchoDamasAudio.isSfxOn && !window.OchoDamasAudio.isSfxOn()) return;
  ...
  function queenEl(fija) {
    var img = document.createElement("img");
    img.src = QUEEN_IMG;
    img.alt = "♛";
    img.className = "queen-piece" + (fija ? " queen-fixed" : "");
    img.draggable = false;
    img.setAttribute("decoding", "async");
    img.onerror = function () {
      var span = document.createElement("span");
      span.className = "queen-piece queen-fallback" + (fija ? " queen-fixed" : "");
      span.textContent = "♛";
    ...
    for (f = 0; f < n; f++) {
      ...
      for (c = 0; c < n; c++) {
        ...
        if (damas.some(function (d) { return d.fila === f && d.col === c; })) {
          var fija = esDamaFija(f, c);
          cell.appendChild(queenEl(fija));
          if (fija) cell.classList.add("fija");
  ...
  function noteMove() {
    try {
      if (window.OchoDamasAudio && window.OchoDamasAudio.onGameplay) {
        window.OchoDamasAudio.onGameplay();
      }
    } catch (eAudio) {}
    playSound();
  ...
  function cambiarIdioma(lang) {
    ...
    try {
      if (window.OchoDamasAudio && window.OchoDamasAudio.syncButtons) {
        window.OchoDamasAudio.syncButtons();
      }
    } catch (eSync) {}
    ...
    var normalSub = document.getElementById("modoNormalSub");
